...
#define CONFIGURATION_OPTIONS " LVS VRRP VRRP_AUTH OLD_CHKSUM_COMPAT FIB_ROUTING"
...
/* Define to 1 if NFTNL_EXPR_LOOKUP_FLAGS defined */
/* #undef HAVE_NFTNL_EXPR_LOOKUP_FLAGS */
...
#define KEEPALIVED_CONFIGURE_OPTIONS "--prefix=/usr/local/keepalived"
...
#define PACKAGE_STRING "Keepalived 2.0.11"
...
#define SYSTEM_OPTIONS " PIPE2 SIGNALFD INOTIFY_INIT1 VSYSLOG EPOLL_CREATE1 IPV4_DEVCONF RTA_ENCAP RTA_NEWDST RTA_PREF FRA_SUPPRESS_PREFIXLEN FRA_SUPPRESS_IFGROUP FRA_TUN_ID RTAX_CC_ALGO RTAX_QUICKACK RTEXT_FILTER_SKIP_STATS RTA_VIA FRA_OIFNAME IFA_FLAGS IP_MULTICAST_ALL LWTUNNEL_ENCAP_MPLS LWTUNNEL_ENCAP_ILA NET_LINUX_IF_H_COLLISION LIBIPTC_LINUX_NET_IF_H_COLLISION IPVS_DEST_ATTR_ADDR_FAMILY IPVS_SYNCD_ATTRIBUTES IPVS_64BIT_STATS VRRP_VMAC CN_PROC SOCK_NONBLOCK SOCK_CLOEXEC O_PATH GLOB_BRACE INET6_ADDR_GEN_MODE VRF SO_MARK SCHED_RT SCHED_RESET_ON_FORK"
...
/* Define to 1 if using iptables command enabled */
#define _USE_IPTABLES_CMD_ 1 
...
/* Define to 1 if have linux/cn_proc.h */
#define _WITH_CN_PROC_ 1 
